        ...
        backGroundVideo && (
            <div className="backGroundVideo h-full w-full pointer-events-none">
                <iframe
                    ...
                    src={`https://www.youtube.com/embed/${backGroundVideo.key}?si=gUwt7UnWbW1XnAxJ&amp;controls=0&autoplay=1&rel=0&loop=1&controls=0&mute=1&showinfo=0&playsinline=1&fullScreen=1&playlist=${backGroundVideo.key}`}
