...
const Header = ({ lang }) => {
    ...
    return (
        <div className="z-50 absolute top-0 left-0 w-full box-border flex justify-between z-100 bg-slate-800">
            <Link to="/browse">
                <img
            ...
            {user && (
                <div className="flex p-4 align-middle">
                    <select className="h-max cursor-pointer rounded-lg p-2 mx-2 bg-gray-900 text-white ">{visibleLang}</select>
                    <button
